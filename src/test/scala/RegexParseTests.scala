...
//
//  test("Simple test") {
//    val s = "CONCAT b CONCAT c STAR d"
//    assert(Dfa.fromPrenex(s).accepts("bcd"))
//    assert(Dfa.fromPrenex(s).accepts("bcdd"))
//    assert(Dfa.fromPrenex(s).accepts("bc"))
//  }
//
//  test("found erorr") {
//    val str = "(bcd*|e)*"
//    val s = "STAR UNION CONCAT b CONCAT c STAR d e"
//    val ast = Ast.fromPrenex(s)
//    println(ast)
//    assert(Nfa.fromPrenex(s).accepts("bce"))
//  }
//
//  test("all basic 7 (6p)") {
...
//    val s = "CONCAT CONCAT a STAR UNION a A STAR UNION CONCAT b CONCAT c UNION STAR d CONCAT d CONCAT c STAR b CONCAT a A"
//    val s1 = "CONCAT a STAR UNION a A"
//    val s2 = "STAR UNION CONCAT b CONCAT c UNION STAR d CONCAT d CONCAT c STAR b CONCAT a A"
//    val s3 = "UNION UNION CONCAT b CONCAT c STAR d CONCAT e CONCAT c STAR f CONCAT a A "
//    assert(Nfa.fromPrenex(s1).accepts("aAaAaA"))
//    assert(Nfa.fromPrenex(s3).accepts("bcdddAaA"))
//    assert(Nfa.fromPrenex(s).accepts("aAaAaAbcddddbcecffffaAaA"))
//  }
//
//  // 70%
//  test("eps (1p)") {
